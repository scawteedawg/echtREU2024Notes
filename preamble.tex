...
\newcommand{\defindex}[1]{\textbf{#1}\index{#1}}


\title{eCHT REU 2024\\Spectra, Spectral Sequences, and (Co)Fibers smashed with $tmf$}
\author{Irina Bobkova, Jack Carlisle, Emmett Fitz,\\ Mattie Ji, Peter Kilway, Hillary Kim,\\ Kolton O'Neal, Jacob Shuckman, Scotty Tilton}
